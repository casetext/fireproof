...
You have to "bless" Fireproof with a promise library that follows the deferral model. Q.js, Kew, and Angular $q are some examples. Just call Fireproof.bless(Q). 
